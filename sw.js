const CACHE='oatf-v6.2';
const SCOPE=new URL(self.registration.scope);
const paths=[
  '', 'index.html','404.html','manifest.webmanifest',
  'assets/styles.css','assets/v4.css','assets/mobile-app.css','assets/v61.css','assets/v62.css',
  'assets/site.js','assets/mobile-app.js','assets/v61.js','assets/v62.js','assets/favicon.svg',
