const CACHE='oatf-v6.5';
const SCOPE=new URL(self.registration.scope);
const paths=[
  '', 'index.html','404.html','manifest.webmanifest',
  'assets/styles.css','assets/v4.css','assets/mobile-app.css','assets/v61.css','assets/v62.css','assets/v63.css','assets/v64.css','assets/v65.css',
  'assets/site.js','assets/mobile-app.js','assets/v61.js','assets/v62.js','assets/v63.js','assets/v64.js','assets/v65.js','assets/favicon.svg',
  ...
  'riversidecountyfair/','sdfair/','orangecountyfair/','marincountyfair/',
